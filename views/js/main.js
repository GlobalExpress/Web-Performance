...
// resizePizzas(size) is called when the slider in the "Our Pizzas" section of the website moves. The change here was to introduce percentages to the case and saving the result within 
// the newWidth variable. 
var resizePizzas = function(size) { 
  ...
  //The previous Dx function has been removed. The sliders value is now used to change the variable newWidth. This new value represents a percentage width to be used in changePizzaSizes
  // Iterates through pizza elements on the page and changes their widths
  function changePizzaSizes(size) {
    var listOfPizzas = document.querySelectorAll(".randomPizzaContainer");
    for (var i = 0; i < listOfPizzas.length; i++) {
      listOfPizzas[i].style.width = newWidth + '%';
    }
  }
...
// This for-loop actually creates and appends all of the pizzas when the page loads. PizzasDiv was removed from the loop.
...
var items = [];
// Moves the sliding background pizzas based on scroll position. The scrollTop calculation was removed from the loop to prevent FSL. Style.transform was introduced replacing
//style.left. This should only trigger composite layers. 
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    var transformValue = items[i].basicLeft + 100 * phase - 1024 + 'px';
    items[i].style.transform = 'translate(' + transformValue + ')';
  }
...
// Generates the sliding pizzas when the page loads. A variable called items is created at this point with all the objects with mover as the class. This var is then 
// used within the updatePositions function. 
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //The numberofPizzas variable stores the required number of pizzas taking into consideration the innerWidth of the page. 
  numberofPizzas = window.innerHeight/s*cols;
